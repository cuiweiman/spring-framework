...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	/**
	 * 将配置文件的路劲 以数组的方式传入，ClassPathXmlApplicationContext 可以对数组进行解析，并加载路径所在的配置文件内容。
	 * setConfigLocations() 方法主要是 解析和处理路径数组，并设置 传入的 配置文件到容器中。
	 * 解析 和 加载 配置文件的配置信息 都在 refresh() 方法中实现。
	 * <p>
	 * Create a new ClassPathXmlApplicationContext with the given parent,
