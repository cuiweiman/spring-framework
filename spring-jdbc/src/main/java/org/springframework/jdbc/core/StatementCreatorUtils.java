...
public abstract class StatementCreatorUtils {
	 ...
	 * of the parameter and we can handle complex types like arrays and LOBs.
	 *
	 * @param ps         the prepared statement or callable statement 语句
	 * @param paramIndex index of the parameter we are setting 参数位置
	 * @param sqlType    the SQL type of the parameter 参数类型
	 * @param inValue    the value to set (plain value or an SqlTypeValue) 参数值
	 * @throws SQLException if thrown by PreparedStatement methods 异常
	 * @see SqlTypeValue
	 */
	 ...
	 * of the parameter and we can handle complex types like arrays and LOBs.
	 *
	 * @param ps         the prepared statement or callable statement sql语句
	 * @param paramIndex index of the parameter we are setting 参数位置
	 * @param sqlType    the SQL type of the parameter 参数类型
	 * @param typeName   the type name of the parameter 参数名称
	 *                   (optional, only used for SQL NULL and SqlTypeValue)
