...
public class ContextLoader {
	...
	/**
	 * 为给定的 servlet context 初始化 Spring 的 WebApplicationContext。
	 * 主要体现了创建 WebApplicationContext 实例的功能。
	 * <p>
	 * 1. WebApplicationContext 存在性的验证。
	 * 2. 创建 WebApplicationContext 实例。{@link #createWebApplicationContext(ServletContext)}
	 * 3. 将 WebApplicationContext 实例记录到 ServletContext 中
